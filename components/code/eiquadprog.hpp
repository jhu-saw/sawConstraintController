...
// https://dl.dropboxusercontent.com/u/260133/QuadProg/eiquadprog.hpp
...
void print_matrix(const std::string &c, Eigen::MatrixXd x, int n)
{
  std::cout << c << ": " << std::endl << x << std::endl << std::endl;
}

void print_vector(const std::string &c, Eigen::VectorXd x, int n)
{
  std::cout << c << ": " << std::endl << x << std::endl << std::endl;
}

void print_ivector(const std::string &c, Eigen::VectorXi x, int n)
{
  std::cout << c << ": " << std::endl << x << std::endl << std::endl;
}
